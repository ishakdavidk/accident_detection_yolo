...
if __name__ == '__main__':
    onnx_path = 'yolov11s_epoch77_frozen2.onnx'     # Path to your YOLOv8 ONNX file
    rknn_path = 'yolov11s_epoch77_frozen2.rknn'     # Output path for the RKNN file
    convert_onnx_to_rknn(onnx_path, rknn_path, do_quantization=False)